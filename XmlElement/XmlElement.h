...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> getchild(){ std::vector < std::shared_ptr < AbstractXmlElement >> vec;  return vec; }
	virtual std::vector<std::pair<std::string, std::string>> getattrib(){ std::vector<std::pair<std::string, std::string>> vec;  return vec; }
  ...
  public:
    ...
    virtual bool addChild(std::shared_ptr<AbstractXmlElement> pChild);
    virtual bool removeChild(std::shared_ptr<AbstractXmlElement> pChild);
	std::vector<std::shared_ptr<AbstractXmlElement>> getchild(){ return children_; }
	std::vector<std::pair<std::string, std::string>> getattrib(){ std::vector<std::pair<std::string, std::string>> vec;  return vec; }
  ...
  public:
	...
	std::vector<std::shared_ptr<AbstractXmlElement>> getchild(){	std::vector < std::shared_ptr < AbstractXmlElement >> vec;  return vec;	}
	std::vector<std::pair<std::string, std::string>> getattrib(){ std::vector<std::pair<std::string, std::string>> vec;  return vec; }
	virtual std::string value();
    virtual std::string toString();
  private:
  ...
  public:
    ...
    virtual bool removeAttrib(const std::string& name);
	std::vector<std::shared_ptr<AbstractXmlElement>> getchild(){ return children_; }
	std::vector<std::pair<std::string, std::string>> getattrib(){ return attribs_; }
    virtual std::string value();
    virtual std::string toString();
  private:
    std::string tag_;
  ...
  private:
    std::vector<std::pair<std::string, std::string>> attribs_;
    std::string type_ = "new proc instruction type";
    std::string text;
  };
